  ...
  return (
    <AppShell showFab>
      ...
      {!state.settings.premium && (
        <Link
          to="/premium"
          className="mt-4 flex items-center gap-3 rounded-2xl border border-gold/30 bg-gold/10 p-4"
        >
          <Crown className="h-5 w-5 shrink-0 text-gold" />
          <span className="min-w-0">
            <span className="block text-sm font-semibold">Private Notes Premium</span>
