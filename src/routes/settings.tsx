    ...
    <AppShell>
      ...
      <SettingsSection title="About">
        <SettingsItem
          ...
          onClick={() =>
            setAbout("Your notes never leave your device in this prototype. No tracking, no ads.")
          }
        />
        <SettingsItem
          icon={Scale}
          label="Terms of Service"
          onClick={() => setAbout("Use Private Notes Vault responsibly and keep your PIN safe.")}
        />
        <SettingsItem
          icon={Info}
          label="About Private Notes Vault"
          onClick={() =>
            setAbout("A private place for your thoughts, protected by a PIN and biometrics.")
          }
        />
        <SettingsItem
          icon={Info}
      ...
      <Dialog open={Boolean(about)} onOpenChange={(v) => !v && setAbout(null)}>
